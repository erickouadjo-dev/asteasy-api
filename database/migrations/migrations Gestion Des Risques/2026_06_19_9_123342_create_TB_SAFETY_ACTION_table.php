...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('TB_SAFETY_ACTION', function (Blueprint $table) {
            ...
            $table->bigInteger('DATE_OUVERTURE');

            $table->bigInteger('ID_TYPE_ORIGINE_ACTION')->comment('Limité à ANALYSE EVENEMENT uniquement !! (pas  de : // FORMATION // PUBLICATION //   EVENEMENT // GESTION DU CHANGEMENT /// etc)');
            $table->foreign('ID_TYPE_ORIGINE_ACTION')->references('ID')->on('TB_TYPE_ORIGINE_ACTION');
            
            $table->bigInteger('ID_TASK_SAFETY');
