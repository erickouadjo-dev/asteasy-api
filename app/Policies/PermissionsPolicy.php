...
class PermissionsPolicy
{
    ...
    public function view(?Utilisateur $user, Permission $permission)
    {
        if (is_null($user)) {
            return Response::deny('Requête non autorisée.');
        }
    ...
    public function update(?Utilisateur $user, Permission $permission)
    {
        return !is_null($user) && $user->type_utilisateur === Utilisateur::TYPE_UTILISATEUR_ADMIN
            ? Response::allow()
            : Response::deny('Requête non autorisée.');
    ...
    public function delete(?Utilisateur $user, Permission $permission)
    {
        return !is_null($user) && $user->type_utilisateur === Utilisateur::TYPE_UTILISATEUR_ADMIN
            ? Response::allow()
            : Response::deny('Requête non autorisée.');
