...
class TypeOrigineActionsPolicy
{
    ...
    public function view(?Utilisateur $user, TypeOrigineAction $typeOrigineAction)
    {
        if (is_null($user)) {
            return Response::deny('Requete non autorisee.');
        }
    ...
    public function update(?Utilisateur $user, TypeOrigineAction $typeOrigineAction)
    {
        return !is_null($user) && in_array($user->type_utilisateur, [Utilisateur::TYPE_UTILISATEUR_ADMIN, Utilisateur::TYPE_UTILISATEUR_POWER_USER])
            ? Response::allow()
            : Response::deny('Requete non autorisee.');
    ...
    public function delete(?Utilisateur $user, TypeOrigineAction $typeOrigineAction)
    {
        return !is_null($user) && in_array($user->type_utilisateur, [Utilisateur::TYPE_UTILISATEUR_ADMIN, Utilisateur::TYPE_UTILISATEUR_POWER_USER])
            ? Response::allow()
            : Response::deny('Requete non autorisee.');
