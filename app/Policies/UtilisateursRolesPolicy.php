...
class UtilisateursRolesPolicy
{
    ...
    public function view(?Utilisateur $user, UtilisateurRole $utilisateurRole)
    {
        if (is_null($user)) {
            return Response::deny('Requête non autorisée.');
        }
    ...
    public function update(?Utilisateur $user, UtilisateurRole $utilisateurRole)
    {
        return !is_null($user) && $user->type_utilisateur === Utilisateur::TYPE_UTILISATEUR_ADMIN
            ? Response::allow()
            : Response::deny('Requête non autorisée.');
    ...
    public function delete(?Utilisateur $user, UtilisateurRole $utilisateurRole)
    {
        return !is_null($user) && $user->type_utilisateur === Utilisateur::TYPE_UTILISATEUR_ADMIN
            ? Response::allow()
            : Response::deny('Requête non autorisée.');
