...
use App\Models\MesureAdditionnelle;
use App\Models\Utilisateur;
use Illuminate\Auth\Access\HandlesAuthorization;
use Illuminate\Auth\Access\Response;

class MesuresAdditionnellesPolicy
{
    ...
    public function view(?Utilisateur $user, MesureAdditionnelle $mesure)
    {
        if (is_null($user)) {
            return Response::deny('Requete non autorisee.');
        }
    ...
    public function update(?Utilisateur $user, MesureAdditionnelle $mesure)
    {
        return !is_null($user) && in_array($user->type_utilisateur, [Utilisateur::TYPE_UTILISATEUR_ADMIN, Utilisateur::TYPE_UTILISATEUR_POWER_USER])
            ? Response::allow()
            : Response::deny('Requete non autorisee.');
    ...
    public function delete(?Utilisateur $user, MesureAdditionnelle $mesure)
    {
        return !is_null($user) && in_array($user->type_utilisateur, [Utilisateur::TYPE_UTILISATEUR_ADMIN, Utilisateur::TYPE_UTILISATEUR_POWER_USER])
            ? Response::allow()
            : Response::deny('Requete non autorisee.');
