...
class EventAnalysesPolicy
{
    ...
    public function view(?Utilisateur $user, EventAnalyse $eventAnalyse)
    {
        if (is_null($user)) {
            return Response::deny('Requête non autorisée.');
        }
    ...
    public function update(?Utilisateur $user, EventAnalyse $eventAnalyse)
    {
        return !is_null($user) && in_array($user->type_utilisateur, [Utilisateur::TYPE_UTILISATEUR_ADMIN, Utilisateur::TYPE_UTILISATEUR_POWER_USER])
            ? Response::allow()
            : Response::deny('Requête non autorisée.');
    ...
    public function delete(?Utilisateur $user, EventAnalyse $eventAnalyse)
    {
        return !is_null($user) && in_array($user->type_utilisateur, [Utilisateur::TYPE_UTILISATEUR_ADMIN, Utilisateur::TYPE_UTILISATEUR_POWER_USER])
            ? Response::allow()
            : Response::deny('Requête non autorisée.');
