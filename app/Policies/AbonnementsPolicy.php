...
class AbonnementsPolicy
{
    ...
    public function view(?Utilisateur $user, Abonnement $abonnement)
    {
        if (is_null($user)) {
            return Response::deny('Requête non autorisée.');
        }
    ...
    public function update(?Utilisateur $user, Abonnement $abonnement)
    {
        return !is_null($user) && $user->type_utilisateur === Utilisateur::TYPE_UTILISATEUR_ADMIN
            ? Response::allow()
            : Response::deny('Requête non autorisée.');
    ...
    public function delete(?Utilisateur $user, Abonnement $abonnement)
    {
        return !is_null($user) && $user->type_utilisateur === Utilisateur::TYPE_UTILISATEUR_ADMIN
            ? Response::allow()
            : Response::deny('Requête non autorisée.');
