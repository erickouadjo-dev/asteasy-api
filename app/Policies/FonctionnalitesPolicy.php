...
class FonctionnalitesPolicy
{
    ...
    public function view(?Utilisateur $user, Fonctionnalite $fonctionnalite)
    {
        if (is_null($user)) {
            return Response::deny('Requête non autorisée.');
        }
    ...
    public function update(?Utilisateur $user, Fonctionnalite $fonctionnalite)
    {
        return !is_null($user) && $user->type_utilisateur === Utilisateur::TYPE_UTILISATEUR_ADMIN
            ? Response::allow()
            : Response::deny('Requête non autorisée.');
    ...
    public function delete(?Utilisateur $user, Fonctionnalite $fonctionnalite)
    {
        return !is_null($user) && $user->type_utilisateur === Utilisateur::TYPE_UTILISATEUR_ADMIN
            ? Response::allow()
            : Response::deny('Requête non autorisée.');
