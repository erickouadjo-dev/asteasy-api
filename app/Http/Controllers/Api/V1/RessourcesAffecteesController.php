...
class RessourcesAffecteesController extends Controller
{
    //
     /**
    ...
    public function index(Request $request)
    {
        try{
            ...
            $result = ExecutionBudgetaire::ressources_affectees($request);
            return response()->json($result, $result['code_http']);
        }catch(\Illuminate\Auth\Access\AuthorizationException $e){
            Log::error('RessourcesAffecteesController@index a échoué avec le message ' . $e->getMessage(), ['trace'=>$e->getTraceAsString()]);
