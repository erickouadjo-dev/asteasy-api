...
class ImporterLeveeFondsController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        try {
            ...
            $result = LeveeFond::importer($request);
            return response()->json($result, $result['code_http']);
        } catch (\Illuminate\Auth\Access\AuthorizationException $e) {
             Log::error('ImporterLeveeFondsController@store a échoué avec le message ' . $e->getMessage(), ['trace'=>$e->getTraceAsString()]);
