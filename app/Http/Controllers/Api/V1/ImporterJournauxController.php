...
class ImporterJournauxController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        try {
            ...
            $result = Journal::importer($request);
            return response()->json($result, $result['code_http']);
        } catch (\Illuminate\Auth\Access\AuthorizationException $e) {
             Log::error('ImporterJournauxController@store a échoué avec le message ' . $e->getMessage(), ['trace'=>$e->getTraceAsString()]);
