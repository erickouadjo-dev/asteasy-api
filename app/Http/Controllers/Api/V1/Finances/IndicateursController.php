...
use App\Utility\Finances\Indicateur;
...
class IndicateursController extends Controller
{
  ...
  public function index(Request $request)
  {
      try{
          ...
          $result = Indicateur::lister($request);
          return response()->json($result, $result['code_http']);
      }catch(\Illuminate\Auth\Access\AuthorizationException $e){
          Log::error('Finances/IndicateursController@index a échoué avec le message ' . $e->getMessage(), ['trace'=>$e->getTraceAsString()]);
