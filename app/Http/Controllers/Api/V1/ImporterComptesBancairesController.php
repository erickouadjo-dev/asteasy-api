...
class ImporterComptesBancairesController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        try {
            ...
            $result = CompteBancaire::importer($request);
            return response()->json($result, $result['code_http']);
        } catch (\Illuminate\Auth\Access\AuthorizationException $e) {
             Log::error('ImporterComptesBancaireController@store a échoué avec le message ' . $e->getMessage(), ['trace'=>$e->getTraceAsString()]);
