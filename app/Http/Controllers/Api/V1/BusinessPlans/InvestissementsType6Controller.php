...
class InvestissementsType6Controller extends Controller
{
    /**
    ...
    {
        try{
            $this->authorize('create', BusinessPlansBpInvestissements::class);
            $result = BpInvestissement::ajouter($request);
