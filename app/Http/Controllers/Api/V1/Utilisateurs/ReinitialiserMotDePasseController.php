    ...
    public function store(Request $request)
    {
        //
         try{
            ...
            $result = Utilisateur::reinitialiserMotDePasse($request);
            return response()->json($result, $result['code_http']);

        }catch(\Illuminate\Auth\Access\AuthorizationException $e){
            
            Log::error('Utilisateur\ReinitialiserMotDePasseController@store a échoué avec le message ' . $e->getMessage(), ['trace'=>$e->getTraceAsString()]);
