...
namespace App\Http\Controllers\Api\V1\Decaissements;
...
class DecaissementController extends Controller
{
    ...
    public function show(Request $request, $id)
    {
        try{
            ...
            $result = $decaissement->lire($request);
            return response()->json($result, $result['code_http']);
        }catch(\Illuminate\Auth\Access\AuthorizationException $e){
            Log::error('Decaissements/DecaissementController@show a échoué avec le message ' . $e->getMessage(), ['trace'=>$e->getTraceAsString()]);
