...
class ImporterMarchesController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        try {
            ...
            $result = Marche::importer($request);
            return response()->json($result, $result['code_http']);
        } catch (\Illuminate\Auth\Access\AuthorizationException $e) {
             Log::error('ImporterMarchesController@store a échoué avec le message ' . $e->getMessage(), ['trace'=>$e->getTraceAsString()]);
