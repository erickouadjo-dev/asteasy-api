...
- **Isolation Multi-Tenant** : Cloisonnement automatique par entreprise. Chaque entreprise ne voit et ne gère que les employés de sa propre structure (`ENTREPRISE_ID`). Les super-administrateurs système ont un accès global.
- Policy:
